...
export const STAGES = [
  {
    id: 'st1',
    name: '1 みちをつくる',
    hint: 'レールを つないで、かべの むこうの カゴまで たまを はこぼう',
    start: { x: 70, y: 58 },
  ...
  },
  {
    id: 'st2',
    name: '2 ドミノ',
    hint: 'たまは みぞに おちる。ドミノで むこうへ つたえて、てっきゅうを おとそう',
    start: { x: 60, y: 58 },
  ...
  },
  {
    id: 'st3',
    name: '3 かぜとジャンプ',
    hint: 'かべが たかい。ジャンプだいで とんで、たりない ぶんは かぜで おそう',
    start: { x: 60, y: 58 },
  ...
  },
  {
    id: 'st4',
    name: '4 トランポリン',
    hint: 'カゴが たかい ところに ある。さかでは のぼれない。トランポリンで はねあげよう',
    start: { x: 70, y: 58 },
  ...
  },
  {
    id: 'st5',
    name: '5 ベルコン',
    hint: 'カゴは たまより たかい ところに ある。ベルコンで はこびあげよう',
    start: { x: 70, y: 58 },
  ...
  },
  {
    id: 'st6',
    name: '6 シーソー',
    hint: 'いたでは みじかくて たにを わたれない。シーソーを はしに しよう',
    start: { x: 70, y: 58 },
  ...
  },
  {
    id: 'st7',
    name: '7 ワープ',
    hint: 'かべは ぜんぶ ふさがっている。あおい うずに はいると ももいろから でてくる',
    start: { x: 70, y: 58 },
    goal: { x: 430, y: 730, w: 104, h: 92 },
  ...
  },
  {
    id: 'st8',
    name: '8 スイッチ',
    hint: 'とびらは スイッチを ふむまで しまっている。さきに スイッチを とおろう',
    start: { x: 70, y: 58 },
    goal: { x: 430, y: 730, w: 104, h: 92 },
  ...
  },
  {
    id: 'st9',
    name: '9 ふりこ',
    hint: 'ふりこは じくを おく。ぶらさがった たまに あてて、みぎへ とばそう',
    start: { x: 70, y: 58 },
  ...
  },
  {
    id: 'st12',
    name: '12 ドミノのはし',
    hint: 'また みぞ。ドミノで わたらせて、おくの てっきゅうを おとそう',
    start: { x: 60, y: 58 },
    goal: { x: 440, y: 730, w: 104, h: 92 },
    walls: [
      FLOOR, ...SIDES,
  ...
  },
  {
    id: 'st13',
    name: '13 かぜでのばす',
    hint: 'とぶ きょりが たりない。かぜで おして、かべの むこうまで とどかせよう',
    start: { x: 70, y: 58 },
  ...
  },
  {
    id: 'st14',
    name: '14 にだんジャンプ',
    hint: 'いっかいでは とどかない。とちゅうの たなを つかって にかいで あがろう',
    start: { x: 70, y: 58 },
    goal: { x: 430, y: 250, w: 104, h: 92 },
    walls: [
      FLOOR, ...SIDES,
  ...
  },
  {
    id: 'st15',
    name: '15 うずまで はこぶ',
    hint: 'うずは したの ほうに ある。たなを よけて そこまで おとそう',
    start: { x: 70, y: 58 },
    goal: { x: 430, y: 730, w: 104, h: 92 },
  ...
  },
  {
    id: 'st16',
    name: '16 いって もどる',
    hint: 'スイッチは みぎ、カゴは ひだり。いってから もどる みちを つくろう',
    start: { x: 70, y: 58 },
  ...
  },
  {
    id: 'st18',
    name: '18 ぎゃくむき',
    hint: 'スタートは みぎうえ、カゴは ひだりした。いままでと ぎゃく',
    start: { x: 465, y: 58 },
  ...
  },
  {
    id: 'st19',
    name: '19 ふりこで とばす',
    hint: 'ふりこの たまで みぎへ はじく。そのさきは ドミノでも レールでも',
    start: { x: 70, y: 58 },
    goal: { x: 440, y: 730, w: 104, h: 92 },
    walls: [
      FLOOR, ...SIDES,
  ...
  },
  {
    id: 'st20',
    name: '20 おおまわり',
    hint: 'さいごは ながい みちのり。つかえるものは ぜんぶ ある',
    start: { x: 70, y: 58 },
    goal: { x: 440, y: 730, w: 104, h: 92 },
    walls: [
      FLOOR, ...SIDES,
